...
public class Main {
	public static void main(String[] args) {
		...
		GraphicText graphicText = new GraphicText("Hellow World");
		draw(graphicText);
		...
		// 오류: class는 Hierachy 상위와 하위만 instanceof 연산자 사용 할 수 있음.
		//System.out.println(circle instanceof Rectangle);
		
		// interface는 hierachy와 상관없이 instanceof 연산자를 사용 할 수 있다.
